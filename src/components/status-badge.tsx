const colorMap: Record<string, { pill: string; dot: string }> = {
  ...
  pending: {
    ...
    dot: 'bg-amber-400 dot-glow-amber',
  },
  running: {
    pill: 'bg-sky-400/10 text-sky-400',
    dot: 'bg-sky-400 dot-glow-blue',
  },
  completed: {
    pill: 'bg-emerald-400/10 text-emerald-400',
    dot: 'bg-emerald-400 dot-glow-green',
  },
  failed: {
    pill: 'bg-red-400/10 text-red-400',
    dot: 'bg-red-400 dot-glow-red',
  },
  ...
  gate_pending: {
    pill: 'bg-soft-violet/10 text-soft-violet',
    dot: 'bg-soft-violet dot-glow-violet',
  },
  rework: {
    pill: 'bg-orange-400/10 text-orange-400',
    dot: 'bg-orange-400 dot-glow-amber',
  },
