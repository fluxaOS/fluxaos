---
name: "end-of-day"
description: "End-of-session ritual: recap what was built since start-of-day, run housekeeping to clean the repo, then prompt memory digestion of closed issues. Run at the end of a work session. Also writes a session-end marker to memory."
---
# End of Day
