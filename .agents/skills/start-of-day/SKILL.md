---
name: "start-of-day"
description: "Session orientation ritual: runs brief (72h git + issues + memory + file mtimes + repo state), plans (in-progress superpowers specs), and ingest (memory doc freshness check) in sequence. Run at the start of a work session to orient the agent. Invoke sub-skills individually with: /start-of-day brief | plans | ingest"
---
# Start of Day
